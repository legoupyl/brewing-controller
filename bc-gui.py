...
def gui():
    ...
    MLT_controller_label2 = tk.Label(panel1, text="MLT",bg='black',font=("Helvetica", FontSize3,'bold'),width=0,height=0,fg='#7ad3fc')
    ...
    BK_controller_label2 = tk.Label(panel1, text='BK',bg='black',font=("Helvetica", FontSize3,'bold'),width=0,height=0,fg='#7ad3fc')
    ...
    HLT_controller_label2 = tk.Label(panel1, text="HLT",bg='black',font=("Helvetica", FontSize3,'bold'),width=0,height=0,fg='#7ad3fc')
